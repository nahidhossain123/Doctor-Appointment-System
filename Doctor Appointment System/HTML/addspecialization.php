...
<body>
	...
	<main class="admin">
                    ...
                    <a href="../HTML/Addinfo.php" style="padding: 8px 20px;border-radius: 4px;" class="btn btn-primary"><span>
		...
		<section class="doctor-manage">
					...
					<div class="container">
						...
						<div class="alert alert-success" role="alert" style="margin-top: 30px; margin-bottom: 0px;padding: 8px 0px 0px 15px;">
					  		<h4 style="display: inline-block;">Add Specialization</h4>
						</div>
						
							
								<form style="padding-top:20px;" action="../PHP/addSpecializationDB.php" method="POST">
								  <div class="form-row text-center">
								  
								    <div class="col-5">
								    	<label>Specialization</label>
								      <input name="specialization" type="text" style="padding: 5px;" class="form-control" placeholder="Medicine">
								       <label style="color:red;"><?php 
								      if(isset($_SESSION['specialization_error']))
								      {
							      		echo $_SESSION['specialization_error'];
								      }								    
								      ?></label>
								    </div>
								    <div class="col-2" >
								    	<label>Submit</label>
									<input type="submit" name="SPECI_ADD_submit"  class="btn btn-primary" style="width: 100%;border-radius: 3px;"  value="Add">
								  	</div>
								  </div>
