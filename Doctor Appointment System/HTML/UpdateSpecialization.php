	...
	<main class="admin">
		...
		<section class="doctor-manage">
					...
					<?php
						...
						$sql="SELECT * from specializations where spe_id='$spe_id'";
					...
					<div class="container">
						...
						<div class="alert alert-success" role="alert" style="margin-top: 30px; margin-bottom: 0px;padding: 8px 0px 0px 15px;">
					  		<h4 style="display: inline-block;">Add Specialization</h4>
								...
								<form style="padding-top:20px;" action="../PHP/Updatespecialization.php?id=<?=$spe_id ?>" method="POST">
								  <div class="form-row text-center">
								  
								    <div class="col-5">
								    	<label>Specialization</label>
								      <input name="specialization" type="text" style="padding: 5px;" class="form-control"  value="<?=$row['specialization'] ?>">
								    ...
								    <div class="col-2" >
								    	<label>Submit</label>
									<input type="submit" name="SPECI_Up_submit"  class="btn btn-primary" style="width: 100%;border-radius: 3px;"  value="Update">
								  	</div>
								  </div>
