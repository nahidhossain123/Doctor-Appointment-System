						...
						<table class="table table-hover table-dark table-sm text-center">
						  <thead>
						    <tr>
						      ...
						      <th scope="col">BDMC</th>
						      <th scope="col">Visit</th>
						      <th scope="col">Spalization</th>
						      <th scope="col">City</th>
						      <th scope="col">Gender</th>
						      <th scope="col">Image</th>	
						      <th scope="col">Manage Info</th>
						    		...
						    		if(mysqli_num_rows($result)>0)
						    		{
						    			while ($row=mysqli_fetch_assoc($result)) {?>		
										    <tr>
										      ...
										      <td class="text-center"><img height="35" width="30" src="../Upload/<?php echo $row['doc_photo']?>"></td>
										      <td ><a class="btn btn-info" href="../HTML/Doctorprofilemanage.php?id=<?php echo $row['doc_id']?>">Manage</a></td>
										      <td><a class="btn btn-primary" href="Updatedoctor.php?id=<?php echo $row['doc_id']?>">Update</a></td>
										      <td><a class="btn btn-danger" href="../PHP/Deletedoctor.php?id=<?php echo $row['doc_id']?>" onclick="return confirm('Do you want to delete this item')">Delete</a></td>
										    </tr>
										    <?php
										}
						    		}
