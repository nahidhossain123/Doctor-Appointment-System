...
<body>
	...
	<main class="doc-appointment">
		<section class="container">
			...
			<div class="col-lg-3 col-sm-12 text-center" style="margin-top: 30px; margin-bottom: 20px;">
                    <a href="../HTML/appointmentList.php" style="padding: 8px 20px;border-radius: 4px;" class="btn btn-primary"><span>
			...
			<?php if(isset($_SESSION["alert_failed_appoint"])){ ?>		
				...
				<?php
				$appoint_id=$_GET['id'];
				$sql="SELECT * from appointments where appoint_id='$appoint_id' ";
				...
				<div class="col-md-6 doctor-add">
					<div class="alert alert-success" role="alert" style="margin-top: 10px; margin-bottom: 0px;padding: 8px 0px 0px 15px;">
					  		<h4 style="display: inline-block;">Appointment</h4>
								...
								<form style="padding-top:30px;" action="../PHP/updateAppointmentDB.php" method="POST">
									<input type="hidden" name="doc_id" id="doc_id" value="<?php echo $_GET['doc_id']?>">
									<input type="hidden" name="appoint_id" id="appoint_id" value="<?php echo $_GET['id']?>">
									<input type="hidden" name="user_id" id="user_id" value="<?php echo $row['user_id']?>">
								  <div class="form-row ">
								    <div class="col-6">
								    	<span>Full Name</span>
								      	<input type="text" name="fullname" style="padding: 5px;" class="form-control" placeholder="patient fullname" value="<?=$row['fullname'] ?>">
								    ...
								    <div class="col-6">
								    	<span>Phone</span>
								      	<input type="text" name="phone" style="padding: 5px;" class="form-control" placeholder="01...." value="<?=$row['phone'] ?>">
							      		<label class="error">*<?php 
								    ...
								    <div class="col-4 form">
								    	...
								    	<?php 
								    		$date=date('Y-m-d');
								    	?>
								      	<input onchange="loadSlot(event)" name="date" type="date" style="padding: 5px;" class="form-control" placeholder="e.g 12/12/20" min="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d',strtotime($date.' +20 days')); ?>" value="<?=$row['appoint_date'] ?>">
								      	<label class="error">*<?php 
								    ...
								    <div class="col-4 form">
								    	<span>Appointment Slot</span>
								      	<select id="SelectSlot" name="slot" style="padding: 6px; width: 100%;" onchange="LoadTime(event)">
								      		<option value="<?=$row['appoint_slot'] ?>"><?php echo $row['appoint_slot'] ?></option>
								      	</select>
								      	<label class="error">*<?php 
								    ...
								    <div class="col-4 form">
								    	<span>Appointment Time</span>
								      	<select id="SelectTime" name="time" style="padding: 6px; width: 100%;">
								      		<option value="<?=$row['appoint_time'] ?>"><?php echo $row['appoint_time'] ?></option>
								      	</select>
								      	<label class="error">*<?php 
								    ...
								    <div class="col-6 form">
								    	<span>City</span>
								      	<input type="text" name="city" style="padding: 5px;" class="form-control" placeholder="e.g Dhaka" value="<?=$row['city'] ?>">
								      	<label class="error">*<?php 
								     ...
								     <div class="col-6 form">
								    	<span>Age</span>
								      	<input type="text" name="age" style="padding: 5px;" class="form-control" placeholder="e.g 18" value="<?=$row['age'] ?>">
								      	<label class="error">*<?php 
								    ...
								    <div class="col-6 form">
								    	...
								    	<?php if($row['patient_type']=="New") { ?>
								    	<input type="radio" name="patient_type" checked="checked" value="New"> New
								    	<?php
								    	}
								    	else{
								    	?>
							    		<input type="radio" name="patient_type" value="New"> New
								    	<?php }
								    	if($row['patient_type']=="Old") {
								    	  ?>
								    	<input type="radio" name="patient_type" checked="checked" value="Old"> Old
								    	<?php } 
								    	else { ?>
								    		<input type="radio" name="patient_type" value="Old"> Old
								    	<?php }
								    	if($row['patient_type']=="Report") { 
								    	?>	
								    	<input type="radio" name="patient_type" checked="checked" value="Report"> Report
								    	<?php }
								    	else{
								    	?>
								    	<input type="radio" name="patient_type" value="Report"> Report
								    	<?php } ?>
								    	<label class="error">*<?php 
								    ...
								    <div class="col-6 form">
								    	...
								    	if($row['gender']=="Female"){
								    	  ?>
								    		<input type="radio" name="gen" checked="checked" value="Female"> Fmale
								    	<?php } 
								    	else { ?>
								    ...
								    <div class="col-6 form">
								    	<span>Address </span>
								    	<textarea name="Address" value="<?=$row['address'] ?>"><?=$row['address'] ?></textarea>
								    	<label class="error">*<?php 
								    ...
								    <div class="col-6 form">
								    	...
								    	<textarea name="problem" value="<?=$row['problem'] ?>"><?=$row['problem'] ?></textarea>
								    	<label class="error">*<?php 
								    ...
								    <div class="col-12 form">
								    	<span>NID</span>
								      	<input type="text" name="nid" style="padding: 5px;" class="form-control" placeholder="43392199 12-09-1999" value="<?=$row['nid'] ?>">
								      	<label class="error">*<?php 
