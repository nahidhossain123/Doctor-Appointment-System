		...
		<section class="doctor-manage">
					...
					<div class="container">
						...
						<div class="alert alert-success" role="alert" style="margin-top: 30px; margin-bottom: 0px;padding: 8px 0px 0px 15px;">
					  		<h4 style="display: inline-block;">Add Educational</h4>
						</div>
						
							
								<form style="padding-top:20px;" action="../PHP/AdddoctoreduDB.php?id=<?php echo $_GET['id'] ?>" method="POST">
								  <div class="form-row text-center">
								  	<div class="col-2">
								  		<label>Degree</label>
								      <input name="degrees" type="text" tyle="padding: 5px;" class="form-control" placeholder="e.g MBBS">
								    ...
								    <div class="col-5">
								      ...
								      <input name="collegename" type="text" style="padding: 5px;" class="form-control" placeholder="e.g Dhaka Medical College">
								       <label style="color:red;"><?php 
								    ...
								    <div class="col-3">
								    	<label>Year</label>
								      <input name="year" type="text" style="padding: 5px;" class="form-control" placeholder="e.g 2019">
								       <label style="color:red;"><?php 
								    ...
								    <div class="col-2" >
								    	<label>Submit</label>
									<input type="submit" name="edusubmit"  class="btn btn-primary" style="width: 100%;border-radius: 3px;"  value="Add">
								  	</div>
								  </div>
