	...
	<main class="admin">
		...
		<section class="doctor-manage">
					...
					<?php
						...
						$sql="SELECT * from degrees where deg_id='$deg_id'";
					...
					<div class="container">
						...
						<div class="alert alert-success" role="alert" style="margin-top: 30px; margin-bottom: 0px;padding: 8px 0px 0px 15px;">
					  		<h4 style="display: inline-block;">Add Degrees</h4>
						</div>
						
							
								<form style="padding-top:20px;" action="../PHP/updateDegreeDB.php?id=<?=$deg_id?>" method="POST">
								  <div class="form-row text-center">
								  
								    <div class="col-5">
								    	<label>Degrees</label>
								      <input name="degree" type="text" style="padding: 5px;" class="form-control" value="<?=$row['degree'] ?>">
								    ...
								    <div class="col-2" >
								    	<label>Submit</label>
									<input type="submit" name="DegUPSUB"  class="btn btn-primary" style="width: 100%;border-radius: 3px;"  value="Update">
								  	</div>
								  </div>
