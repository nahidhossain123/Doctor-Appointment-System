			...
			<div class="row">
				<div class="col-md-6 doctor-add">
					<div class="alert alert-success" role="alert" style="margin-top: 10px; margin-bottom: 0px;padding: 8px 0px 0px 15px;">
					  		<h4 style="display: inline-block;">Update Appointment</h4>
						</div>
								
							
								<form style="padding-top:30px;" action="../PHP/UpdateAppointmentDBuser.php" method="POST">
								  ...
								  <div class="form-row ">
								    ...
								    <div class="col-12 form" >
									<input type="submit" name="appionmentSUbuser"  class="btn btn-primary" style="width: 100%;border-radius: 3px;" value="Update Appointment">
								  	</div>
								  </div>
